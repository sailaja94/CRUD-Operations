...
<td> <button  onClick={eShow} className="btn edit"><i className="fas fa-user-edit"></i></button>

</td>
<td> <button  onClick={dShow} className="btn delete"><i className="fas fa-user-minus"></i></button>
